...
CREATE FUNCTION collectrawpo(baselinedate VARCHAR, usename VARCHAR, settingref VARCHAR) RETURNS TABLE (
	...
	Select
		...
		shiptoInfo."Country" :: varchar(100),  -- as "DistributorShipToCountrysId",
		...
		shiptoInfo."State" :: varchar(100),  -- as "DistributorShipToStatesId",
		...
		shiptoInfo."Province" :: varchar(100),  -- as "DistributorShipToProvincesId",
		...
		shiptoInfo."City" :: varchar(100),  -- as "DistributorShipToCitysId",
		...
		shiptoInfo."District" :: varchar(100),  -- as "DistributorShipToDistrictsId",
		...
		shiptoInfo."Wards" :: varchar(100),  -- as "DistributorShipToWardsId",
