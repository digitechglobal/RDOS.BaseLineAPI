...
CREATE FUNCTION collectrawpo(baselinedate VARCHAR, settingref VARCHAR) RETURNS TABLE (
	...
	"PODescription" varchar(250),
	"TransactionDate" timestamp,
	"ExpectReDate" timestamp,
	"POConfirmNumber" varchar(50),
	"PoPrincipalNumber" varchar(50),
	"POConfirmDate" timestamp,
	"POConfirmDescription" varchar(250),
	"GRPONumber" varchar(50),
	"GRPODate" timestamp,
	"Status" varchar(50),
	"Type" varchar(50),
	"PrincipalRefNumber" varchar(50),
	"ItemId" varchar(50),
	"InventoryShortName" varchar(50),
	"InventoryReportName" varchar(50),
	"InventoryDescription" varchar(250),
	"ERPId" varchar(50),
	"ItemGroupId" varchar(50),
	"OrderQuantity" integer,
	"OrderUOM" varchar(50),
	"UnitPrice" decimal,
	"OrderBaseQuantity" integer,
	"OrderBaseUOM" varchar(50),
	"ConfirmedQuantity" integer,
	"ConfirmedUOM" varchar(50),
	"ConfirmedBaseQuantity" integer,
	"ConfirmedBaseUOM" varchar(50),
	"ReceiptQuantity" integer,
	"ReceiptUOM" varchar(50),
	"ReceiptBaseQuantity" integer,
	"ReceiptBaseUOM" varchar(50),
	"Vat" decimal,
	"VatId" varchar(50),
	"IsFree" boolean,
	"DiscountSchemeId" varchar(100),
	...
	"SicId" varchar(100),
	"PrincipalWareHouseId" varchar(100),
	...
	Select
		...
		poOrderInfo."PurchaseOrderNumber" :: varchar(50),  -- as "PurchaseOrderNumber",
		poOrderInfo."Description" :: varchar(250),  -- as "PODescription",
		poOrderInfo."PoDate" :: timestamp,  -- as "TransactionDate",
		poOrderInfo."ExpectReDate" :: timestamp,  -- as "ExpectReDate",
		poConfirmInfo."PurchaseOrderConfirmNumber" :: varchar(50),  -- as "POConfirmNumber",
		poConfirmInfo."PoPrincipalNumber" :: varchar(50),  -- as "PoPrincipalNumber",
		poConfirmInfo."TransactionDate" :: timestamp,  -- as "POConfirmDate",
		poConfirmInfo."Description" :: varchar(250),  -- as "POConfirmDescription",
		grpoInfo."GRPONumber" :: varchar(50),  -- as "GRPONumber",
		grpoInfo."GRPODate" :: timestamp,  -- as "GRPODate",
		grpoInfo."Status" :: varchar(50),  -- as "Status",
		grpoInfo."Type" :: varchar(50),  -- as "Type",
		grpoInfo."PrincipalRefNumber" :: varchar(50),  -- as "PrincipalRefNumber",
		itemOrder."ItemCode" :: varchar(50),  -- as "ItemId",
		inventoryItem."ShortName" :: varchar(50),  -- as "InventoryShortName",
		inventoryItem."ReportName" :: varchar(50),  -- as "InventoryReportName",
		inventoryItem."Description" :: varchar(250),  -- as "InventoryDescription",
		inventoryItem."ERPCode" :: varchar(50),  -- as "ERPId",
		itemOrder."ItemGroupCode" :: varchar(50),  -- as "ItemGroupId",
		itemPo."OrderQuantity" :: integer,  -- as "OrderQuantity",
		itemPo."Uom" :: varchar(50),  -- as "OrderUOM",
		itemPo."UnitPrice" :: decimal,  -- as "UnitPrice",
		itemPo."OrderBaseQuantity" :: integer,  -- as "OrderBaseQuantity",
		itemPo."BaseUom" :: varchar(50),  -- as "OrderBaseUOM",
		itemPoConfirm."ConfirmedQuantity" :: integer,  -- as "ConfirmedQuantity",
		itemPoConfirm."Uom" :: varchar(50),  -- as "ConfirmedUOM",
		itemPoConfirm."BaseQuantity" :: integer,  -- as "ConfirmedBaseQuantity",
		itemPo."BaseUom" :: varchar(50),  -- as "ConfirmedBaseUOM",
		itemOrder."ReceiptQuantity" :: integer,  -- as "ReceiptQuantity",
		itemOrder."Uom" :: varchar(50),  -- as "ReceiptUOM",
		itemOrder."ReceiptBaseQuantity" :: integer,  -- as "ReceiptBaseQuantity",
		itemOrder."BaseUom" :: varchar(50),  -- as "ReceiptBaseUOM",
		itemOrder."Vat" :: decimal,  -- as "Vat",
		itemOrder."VatCode" :: varchar(50),  -- as "VatId",
		itemOrder."IsFree" :: boolean,  -- as "IsFree",
		itemOrder."DiscountSchemeId" :: varchar(100),  -- as "DiscountSchemeId",
		NULL :: varchar(50),
		NULL :: varchar(255),
		NULL :: varchar(255),
		NULL :: varchar(255),
		grpoInfo."DistributorCode" :: varchar(50),  -- as "DistributorId",
		distributorInfo."Name" :: varchar(250),  -- as "DistributorName",
		distributorInfo."DMSCode" :: varchar(50),  -- as "DMSCode",
		distributorInfo."PrincipalLinkedCode" :: varchar(100),  -- as "PrincipalLinkedCode",
		-- distributorInfo."BusinessAddressCountry" :: varchar(100),  -- as "DistributorCountrysId",
		...
		-- distributorInfo."BusinessAddressState" :: uuid,  -- as "DistributorStatesId",
		...
		-- distributorInfo."BusinessAddressProvince" :: uuid,  -- as "DistributorProvincesId",
		...
		-- distributorInfo."BusinessAddressCity" :: uuid,  -- as "DistributorCitysId",
		...
		-- distributorInfo."BusinessAddressDistrict" :: uuid,  -- as "DistributorDistrictsId",
		...
		-- distributorInfo."BusinessAddressWard" :: uuid,  -- as "DistributorWardsId",
		...
		itemOrder."WareHouse" :: varchar(100),  -- as "DistributorShiptoId",
		...
		shiptoInfo."Chanels" :: varchar(255),  -- as "Channels",
		shiptoInfo."SubChanels" :: varchar(255),  -- as "SubChanels",
		shiptoInfo."SicId" :: varchar(100),  -- as "SicId",
		grpoInfo."PrincipalWareHouseCode" :: varchar(100),  -- as "PrincipalWareHouseId",
	...
	From 
		...
		join "PO_GRPOHeaders" as grpoInfo on grpoInfo."GRPONumber" = itemOrder."GRPONumber"
		join "PO_POConfirmHeaders" as poConfirmInfo on poConfirmInfo."PurchaseOrderConfirmNumber" = grpoInfo."PurchaseOrderConfirmNumber"
		join "PO_OrderHeaders" as poOrderInfo on poOrderInfo."PurchaseOrderNumber" = poConfirmInfo."PurchaseOrderNumber"
		join "PO_OrderDetails" as itemPo on itemPo."PurchaseOrderNumber" = poOrderInfo."PurchaseOrderNumber" 
		and itemPo."ItemCode" = itemOrder."ItemCode" and itemPo."Uom" = itemOrder."Uom"
		join "PO_POConfirmDetailItems" as itemPoConfirm on itemPoConfirm."PurchaseOrderConfirmNumber" = poConfirmInfo."PurchaseOrderConfirmNumber" 
		and itemPoConfirm."ItemCode" = itemOrder."ItemCode" and itemPoConfirm."Uom" = itemOrder."Uom"
		join "Distributors" as distributorInfo on distributorInfo."Code" = grpoInfo."DistributorCode"
		...
		join "DistributorShiptos" as shiptoInfo on shiptoInfo."ShiptoCode" = itemOrder."WareHouse"
		...
		and CAST(baselinedate AS DATE) =
			...
			END
		and (poConfirmInfo."Status" = 'ST09' or poConfirmInfo."Status" = 'ST10')
;
END $func$;
SELECT
    *
