...
CREATE FUNCTION collectcloseadjustment(baselinedate VARCHAR, usename VARCHAR, settingref VARCHAR) RETURNS TABLE (
    ...
    "CloseQuantityBaseUOM" varchar(255),
    "CloseSalesQuantity" integer,
	"CloseSalesUOM" varchar(100),
	"ClosePurchaseQuantity" integer,
	"ColosePurchaseUOM" varchar(100),
    ...
    Select
        ...
        invtransaction."EndQty" :: integer, --as "OutQuantity",
        -- allocationdetail."BaseUom" :: varchar(255), --as "OutBaseUOM",
        baseuom."UomId" :: varchar(255), --as "OutBaseUOM",
		(invtransaction."EndQty" / salesconvs."ConversionFactor") :: integer,
		salesuom."UomId":: varchar(100),
		(invtransaction."EndQty" / purchaseconvs."ConversionFactor") :: integer, 
