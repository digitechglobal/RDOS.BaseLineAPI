...
CREATE FUNCTION collectissueadjustment(baselinedate VARCHAR, settingref VARCHAR, typedata VARCHAR) RETURNS TABLE (
    ...
    "OutQuantityType" varchar(50),
    "OutQuantityTypeValue" varchar(255),
    "OutQuantityTypeDesc" varchar(255),
    "OutQuantity" integer,
    "OutBaseUOM" varchar(255),
	"OutSalesQuantity" integer,
	"OutSalesUOM" varchar(100),
	"OutPurchaseQuantity" integer,
	"OutPurchaseUOM" varchar(100),
    ...
    Select
		...
		(invtransaction."Issue" / purchaseconvs."ConversionFactor") :: integer, 
    ...
    where 
        ...
        and invtransaction."TransactionType" = 'INV02'
;
END $func$;
SELECT
    *
...
CREATE FUNCTION collectissueinv(baselinedate VARCHAR, settingref VARCHAR, typedata VARCHAR) RETURNS TABLE (
    ...
    where 
        invtransaction."IsDeleted" = false
        and CAST(baselinedate as DATE) = CAST(invtransaction."TransactionDate" as DATE)
        and (invtransaction."TransactionType" = 'INV04' 
        or invtransaction."TransactionType" = 'INV06' 
        or invtransaction."TransactionType" = 'INV09'
        or invtransaction."TransactionType" = 'INV12'
        or invtransaction."TransactionType" = 'INV13'
        or invtransaction."TransactionType" = 'INV02')
;
END $func$;
SELECT
    *
